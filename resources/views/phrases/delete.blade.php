@extends('layouts.app')
@section('title', $title = __('messages.phrases.deleting'))
@section('content')
    <div class="container">
        <nav
        ...
        <h4>
{{--            Вы уверены, что хотите удалить фразу--}}
            {{ __('messages.phrases.are_you_sure') }}: <span class="b">{{ $phrase->phrase }}</span> ({{ $phrase->translate }})</h4>
