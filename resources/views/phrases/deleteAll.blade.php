@extends('layouts.app')
@section('title', $title = __('messages.phrases.delete_all_phrases').': '. $section->title)
@section('content')
    <div class="container">
        <nav
...
{{--            Вы уверены, что хотите удалить все фразы из раздела--}}
            {{ __('messages.phrases.confirmed_delete') }}: <span class="b">{{ $section->title }}</span>?</h4>
